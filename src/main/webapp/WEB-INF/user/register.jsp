...
<div class="container">
    ...
    <form action="register" method="post" class="form">
        <input required="" class="input" type="text" name="username" id="Name" placeholder="Userame">
        <input required="" class="input" type="email" name="email" id="email" placeholder="E-mail">
        <input required="" class="input" type="password" name="password" id="password" placeholder="Password">
        <input required="" class="input" type="password" name="password2" id="password2" placeholder="Confirm Password">
    ...
    <div class="social-account-container">
        <span class="title" style="font-size: 15px">Or Sign up with</span>
