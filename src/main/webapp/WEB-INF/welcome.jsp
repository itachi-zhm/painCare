...
<section class="hero">
    <div class="hero__image">
        ...
        <div class="hero__content">
            <h1 class="hero__title">Welcome to PainCare Website </h1>
            <div class="hero__text">"it is a real-life switch that could change the world around you when life is hard."</div>
        ...
        <form action="login" method="get">
            <input type="submit" value="Sign in" class="text">
        </form>
...
<section>
    <ul class='slider'>
        <li class='item' style="background-image: url('https://i.insider.com/659883fa6979d73718210796?width=500&format=jpeg&auto=webp')">
            <div class='content'>
                <h2 class='title'>"Here's why period cramps can hurt even more than a heart attack, according to science"</h2>
                <p class='description'> Period cramps can be miserable. While one
                    doctor compared them to a heart attack,
                    another said that the comparison isn't
                    accurate because many heart attacks are
                    actually mild.
                    Millions of women around the globe know that period
                    cramps can be miserable. But doctors are finally starting to
                    validate just how painful these camps can be.
                    Back in 201 6, Quartz published an arti... [+2414 chars]  </p>
                <button><a href="https://www.insider.com/are-period-cramps-more-painful-than-heart-attack-2018-3">Read More</a></button>
            </div>
        </li>
        <li class='item' style="background-image: url('https://www.tomakeamommy.com/wp-content/uploads/2023/12/The-True-Costs-of-IVF-Picture-of-Couple-with-Doctor-Discussing-Infertility-1536x864.jpg')">
            <div class='content'>
                <h2 class='title'>"The True Costs of IVF: What Your Doctor: Isn't Telling You"</h2>
                <p class='description'> Women who undergo in vitro fertilization (IVF),
                    a medical treatment to help infertile people
                    conceive a baby, are 66% more likely to be
                    hospitalized for a stroke within 12 months
                    of delivery compared to those who delivered
                    after spontaneous conception. This n...
                    Women who undergo in vitro fertilization (IVF), a medical
                    treatment to help infertile people conceive a baby, are 66%
                    more likely to be hospitalized for a stroke within 12 months
                    of delivery compared... [+7072 chars]  </p>
                <button><a href="https://www.tomakeamommy.com/the-true-costs-of-ivf/">Read More</a></button>
            </div>
        </li>
        <li class='item' style="background-image: url('https://i.insider.com/656e23e158e7c0c29a295a03?width=1000&format=jpeg&auto=webp')">
            <div class='content'>
                <h2 class='title'>"It took me 11 years to be diagnosed with
                    a compressed pelvic nerve. Doctors didn't
                    believe my pain was real."</h2>
                <p class='description'> It took her 11 years for a doctor to finally find
                    a compression in a pelvic nerve. Previous
                    doctors had disregarded her pain as being all
                    in her head.
                    For 11 years, I sought answers for strange pains. Over and
                    over, I explained the problem to doctors: persistent pain in
                    the right groin, pain that spiked when I sat for more than a
                    few minutes or wal... 1+3094 chars]  </p>
                <button><a href="https://www.businessinsider.com/doctors-said-pain-was-made-up-had-nerve-compression-2023-12">Read More</a></button>
            </div>
        </li>
        <li class='item' style="background-image: url('https://images.theconversation.com/files/566750/original/file-20231219-27-7x7oaq.jpg?ixlib=rb-1.1.0&rect=0%2C164%2C1278%2C638&q=45&auto=format&w=1356&h=668&fit=crop')">
            <div class='content'>
                <h2 class='title'>"Got period pain or cramps? What to eat
                    and avoid, according to science"</h2>
                <p class='description'>
                    IA cup of coffee might help you kick-start your
                    day, but it may actually make painful periods
                    Worse. Here's what else to avoid (and eat) if
                    ou have period pain.
                    ora Shimazaki/Pexels
                    Painful periods are common. More than half of people who
                    enstruate have some pain for up to three days a month,
                    ypically throbbing or cramping in the lower abdomen.
                    Digesti... [+6388 chars]
                </p>
                <button><a href="https://theconversation.com/got-period-pain-or-cramps-what-to-eat-and-avoid-according-to-science-218344">Read More</a></button>
            </div>
        </li>
        <li class='item' style="background-image: url('https://cdn.vox-cdn.com/thumbor/d9YWF0nkSIQwgEynX2-ui3gnK7c=/0x0:1920x1104/1820x1024/filters:focal(807x399:1113x705):format(webp)/cdn.vox-cdn.com/uploads/chorus_image/image/72834089/EvaClaycomb_VoxHighlight.0.jpg')">
            <div class='content'>
                <h2 class='title'>"The weird, bad history of tampon testing"</h2>
                <p class='description'>
                    enstruation stigma shapes the products we
                    uy — and hurts our health.
                    f youve ever had a period or if you just watched a lot of TV
                    n the 1990s you probably remember the blue-liquid ads.
                    n one example from 1 995, an actor extols the virtues of
                    Iways maxi pads as sap... [+12498 chars]
                </p>
                <button><a href="https://www.vox.com/the-highlight/23893044/period-tampon-menstrual-cycle-menstruation-cup-pad">Read More</a></button>
            </div>
        </li>
        <li class='item' style="background-image: url('https://imageio.forbes.com/specials-images/imageserve/657a198d4b248c6ac9ee8fef/1930s-FEMALE-CHEMIST---/960x0.jpg?format=jpg&width=1440')">
            <div class='content'>
                <h2 class='title'>"Guidea Donates UX To 30 Startup
                    FemTech Companies"</h2>
                <p class='description'> Estimates for FemTech's current market size
                    range from $500 million to $1 billion and are
                    predicted to have double-digit revenue growth
                    in the coming years.
                    1930s FEMALE CHEMIST SCIENTIST POURING LIQUID
                    INTO A BEAKER (Photo by Camerique/ClassicStock/Getty
                    [+1 Images)
                    getty
                    ln 2022, McKinsey declared it was the 'dawn of the
                    FemTech revolution.' But ... [+6009 chars]  </p>
                <button><a href="https://cdn.vox-cdn.com/thumbor/d9YWF0nkSIQwgEynX2-ui3gnK7c=/0x0:1920x1104/1820x1024/filters:focal(807x399:1113x705):format(webp)/cdn.vox-cdn.com/uploads/chorus_image/image/72834089/EvaClaycomb_VoxHighlight.0.jpg">Read More</a></button>
            </div>
        </li>
    </ul>
    <nav class='nav'>
